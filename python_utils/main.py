...
def generate_model_json(args):
  ...
  layers = []
  marker = 0
  reader = tf.train.NewCheckpointReader('./final_model_5/best_model')
  sess = tf.Session()

  saver = tf.train.import_meta_graph('./final_model_5/best_model.meta')
  saver.restore(sess, './final_model_5/best_model')
